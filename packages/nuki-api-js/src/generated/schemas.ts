...
export const accountConfigSchema = z.object({
	...
	otpEnabledDate: z.optional(z.iso.datetime().describe("The opt enabled date")),
});
...
export const termsOfUseSchema = z.object({
	...
	acceptanceDate: z.optional(z.iso.datetime()),
});
...
export const accountIntegrationSchema = z.object({
	...
	createdAt: z.optional(z.iso.datetime().describe("First creation date of the token")),
	lastActiveAt: z.optional(z.iso.datetime().describe("Last refresh date of the token")),
	scopes: z.optional(
...
export const apiKeyAdvancedSchema = z.object({
	...
	updateDate: z.optional(z.iso.datetime()),
...
export const conditionsSchema = z.object({
	...
	modifiedSince: z.optional(z.iso.datetime()),
	get noneMatch() {
		return z.array(tagSchema).optional();
	},
	rangeDate: z.optional(z.iso.datetime()),
	get rangeTag() {
		return tagSchema.optional();
	},
	unmodifiedSince: z.optional(z.iso.datetime()),
});
...
export const notificationSchema = z.object({
	...
	lastActiveDate: z.optional(z.iso.datetime().describe("The last active date")),
	get settings() {
...
export const openerIntercomModelSchema = z.object({
	...
	creationDate: z.optional(z.iso.datetime().describe("The creation date")),
	updateDate: z.optional(z.iso.datetime().describe("The update date")),
});
...
export const representationSchema = z.object({
	...
	modificationDate: z.optional(z.iso.datetime()),
	get tag() {
		return tagSchema.optional();
	},
...
export const responseSchema = z.object({
	...
	retryAfter: z.optional(z.iso.datetime()),
	get serverInfo() {
...
export const smartlockAuthSchema = z.object({
	...
	allowedFromDate: z.optional(z.iso.datetime().describe("The allowed from date")),
	allowedUntilDate: z.optional(z.iso.datetime().describe("The allowed until date")),
...
export const webhookMessageSchema = z.object({
	...
	timestamp: z.optional(z.iso.datetime().describe("The timestamp when the message was created")),
