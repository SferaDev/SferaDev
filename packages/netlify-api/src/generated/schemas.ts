...
export const databaseResponseSchema = z
	.object({
		connection_string: z.optional(z.string().describe("The connection string for the database")),
	})
...
export const envVarSchema = z
	.object({
		...
		updated_at: z.optional(
			z.iso.datetime().describe("The timestamp of when the value was last updated"),
		),
 ...
 */
export const createSiteDatabase200Schema = z
	.object({
		connection_string: z.optional(z.string().describe("The connection string for the database")),
	})
	.describe("Response containing the database connection string");
 ...
 * @description Created
 */
export const createSiteDatabase201Schema = z
	.object({
		connection_string: z.optional(z.string().describe("The connection string for the database")),
	})
	.describe("Response containing the database connection string");
...
export const createSiteDatabaseMutationRequestSchema = z
	.object({
		region: z.optional(
			z
				.string()
...
export const createSiteDatabaseMutationResponseSchema = z.union([
	z.lazy(() => createSiteDatabase200Schema),
	z.lazy(() => createSiteDatabase201Schema),
]);

export const getSiteDatabasePathParamsSchema = z.object({
	site_id: z.string(),
});
 ...
 * @description OK
 */
export const getSiteDatabase200Schema = z
	.object({
		connection_string: z.optional(z.string().describe("The connection string for the database")),
	})
	.describe("Response containing the database connection string");
...
export const getSiteDatabaseQueryResponseSchema = z.lazy(() => getSiteDatabase200Schema);

export const deleteSiteDatabasePathParamsSchema = z.object({
	site_id: z.string(),
});
 ...
 * @description Deleted
 */
export const deleteSiteDatabase204Schema = z.unknown();
...
export const deleteSiteDatabaseMutationResponseSchema = z.lazy(() => deleteSiteDatabase204Schema);

export const createSiteDatabaseBranchPathParamsSchema = z.object({
	site_id: z.string(),
});
 ...
 * @description Created
 */
export const createSiteDatabaseBranch201Schema = z
	.object({
		connection_string: z.optional(
			z.string().describe("The connection string for the database branch"),
		),
...
export const createSiteDatabaseBranchMutationRequestSchema = z
	.object({
		parent_branch_id: z.optional(
			z
				.string()
...
export const createSiteDatabaseBranchMutationResponseSchema = z.union([
	z.lazy(() => createSiteDatabaseBranch200Schema),
 ...
 * @description OK
 */
export const getSiteDatabaseBranch200Schema = z
	.object({
		connection_string: z.optional(
			z.string().describe("The connection string for the database branch"),
		),
...
export const getSiteDatabaseBranchQueryResponseSchema = z.lazy(
	() => getSiteDatabaseBranch200Schema,
);
 ...
 * @description Deleted
 */
export const deleteSiteDatabaseBranch204Schema = z.unknown();
...
export const deleteSiteDatabaseBranchMutationResponseSchema = z.lazy(
...
export const createSiteDatabaseSnapshotMutationResponseSchema = z.lazy(
	() => createSiteDatabaseSnapshot201Schema,
);

export const listSiteDatabaseSnapshotsPathParamsSchema = z.object({
	site_id: z.string(),
});
 ...
 * @description OK
 */
export const listSiteDatabaseSnapshots200Schema = z
	.object({
		snapshots: z.optional(
			z
				.array(
...
export const listSiteDatabaseSnapshotsQueryResponseSchema = z.lazy(
	() => listSiteDatabaseSnapshots200Schema,
);

export const deleteSiteDatabaseSnapshotPathParamsSchema = z.object({
	site_id: z.string(),
 ...
 * @description Deleted
 */
export const deleteSiteDatabaseSnapshot204Schema = z.unknown();
...
export const deleteSiteDatabaseSnapshotMutationResponseSchema = z.lazy(
	() => deleteSiteDatabaseSnapshot204Schema,
);

export const restoreSiteDatabaseSnapshotPathParamsSchema = z.object({
	site_id: z.string(),
 ...
 * @description OK
 */
export const restoreSiteDatabaseSnapshot200Schema = z.unknown();
...
export const restoreSiteDatabaseSnapshotMutationResponseSchema = z.lazy(
	() => restoreSiteDatabaseSnapshot200Schema,
);
