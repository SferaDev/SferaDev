...
export const operationsByPath = {
	...
	"GET /accounts/{accountId}/resource-library/applications": getApplications,
	"POST /accounts/{accountId}/resource-library/applications": createApplication,
	"GET /accounts/{accountId}/resource-library/applications/{id}": getApplicationById,
	"PATCH /accounts/{accountId}/resource-library/applications/{id}": updateApplicationVersion,
	"GET /accounts/{accountId}/resource-library/categories": getCategories,
	"GET /accounts/{accountId}/resource-library/categories/{id}": getCategoryById,
	...
	"GET /accounts/{account_id}/abuse-reports/{report_id}/emails": listEmails,
	...
	"GET /accounts/{account_id}/ai-search/instances/{id}/jobs/{job_id}/logs":
		aiSearchInstanceListJobLogs,
	"POST /accounts/{account_id}/ai-search/instances/{id}/search": aiSearchInstanceSearch,
	...
	"GET /accounts/{account_id}/cloudforce-one/events/queries/alerts": getEventQueryAlertList,
	...
	"PATCH /accounts/{account_id}/cloudforce-one/events/queries/{query_id}": patchEventQueryUpdate,
	"POST /accounts/{account_id}/cloudforce-one/events/queries/{query_id}": postEventQueryUpdate,
	...
	"GET /accounts/{account_id}/cloudforce-one/events/targetIndustries/catalog":
		getTargetIndustryListComplete,
	"DELETE /accounts/{account_id}/cloudforce-one/events/{dataset_id}/delete": deleteEventDelete,
	...
	"DELETE /accounts/{account_id}/custom_ns/{custom_ns_id}":
		accountLevelCustomNameserversDeleteAccountCustomNameserver,
	"GET /accounts/{account_id}/d1/database": d1ListDatabases,
	"POST /accounts/{account_id}/d1/database": d1CreateDatabase,
	"DELETE /accounts/{account_id}/d1/database/{database_id}": d1DeleteDatabase,
	"GET /accounts/{account_id}/d1/database/{database_id}": d1GetDatabase,
	"PATCH /accounts/{account_id}/d1/database/{database_id}": d1UpdatePartialDatabase,
	"PUT /accounts/{account_id}/d1/database/{database_id}": d1UpdateDatabase,
	"POST /accounts/{account_id}/d1/database/{database_id}/export": d1ExportDatabase,
	"POST /accounts/{account_id}/d1/database/{database_id}/import": d1ImportDatabase,
	"POST /accounts/{account_id}/d1/database/{database_id}/query": d1QueryDatabase,
	"POST /accounts/{account_id}/d1/database/{database_id}/raw": d1RawDatabaseQuery,
	"GET /accounts/{account_id}/d1/database/{database_id}/time_travel/bookmark":
		d1TimeTravelGetBookmark,
	"POST /accounts/{account_id}/d1/database/{database_id}/time_travel/restore": d1TimeTravelRestore,
	"GET /accounts/{account_id}/devices": devicesListDevices,
	"GET /accounts/{account_id}/devices/ip-profiles": listIpProfiles,
	"POST /accounts/{account_id}/devices/ip-profiles": createIpProfile,
	"DELETE /accounts/{account_id}/devices/ip-profiles/{profile_id}": deleteIpProfile,
	"GET /accounts/{account_id}/devices/ip-profiles/{profile_id}": getIpProfile,
	"PATCH /accounts/{account_id}/devices/ip-profiles/{profile_id}": updateIpProfile,
	...
	"GET /accounts/{account_id}/dex/http-tests/{test_id}/percentiles":
		dexEndpointsHttpTestPercentiles,
	"GET /accounts/{account_id}/dex/rules": listDexRules,
	"POST /accounts/{account_id}/dex/rules": createDexRule,
	"DELETE /accounts/{account_id}/dex/rules/{rule_id}": deleteDexRule,
	"GET /accounts/{account_id}/dex/rules/{rule_id}": getDexRule,
	"PATCH /accounts/{account_id}/dex/rules/{rule_id}": updateDexRule,
	...
	"PATCH /accounts/{account_id}/zerotrust/subnets/cloudflare_source/{address_family}":
		zeroTrustNetworksSubnetUpdateCloudflareSource,
	"POST /accounts/{account_id}/zerotrust/subnets/warp": zeroTrustNetworksSubnetCreateWarp,
	"DELETE /accounts/{account_id}/zerotrust/subnets/warp/{subnet_id}":
		zeroTrustNetworksSubnetDeleteWarp,
	"GET /accounts/{account_id}/zerotrust/subnets/warp/{subnet_id}": zeroTrustNetworksSubnetGetWarp,
	...
	"GET /destinations": destinationList,
	"POST /destinations": destinationCreate,
	"DELETE /destinations/{slug}": destinationsDelete,
	"PATCH /destinations/{slug}": destinationUpdate,
	...
	"GET /radar/bgp/rpki/aspa/changes": radarGetBgpRpkiAspaChanges,
	"GET /radar/bgp/rpki/aspa/snapshot": radarGetBgpRpkiAspaSnapshot,
	"GET /radar/bgp/rpki/aspa/timeseries": radarGetBgpRpkiAspaTimeseries,
