		...
		payload: z.optional(
			z.union([
				...
				z.object({
					...
					requestedTeamSlug: z.optional(z.string()),
				...
				z.object({
					...
					conditions: z.array(
						z.object({
							...
							cmpOptions: z.optional(
								z.object({
									ignoreCase: z.optional(z.union([z.literal(false), z.literal(true)])),
								}),
							),
							lhs: z.union([
								z.object({
...
export const segmentSchema = z.object({
	...
	usedByFlags: z.optional(z.array(z.string())),
	usedBySegments: z.optional(z.array(z.string())),
	id: z.string(),
	label: z.string(),
	slug: z.string(),
	createdAt: z.number(),
			...
			z
				...
				.catchall(
					z
						.object({
							volume: z.string(),
							mode: z.optional(z.enum(["read-only", "read-write"])),
						})
...
export const teamSchema = z
	.object({
		...
		disableRepositoryDispatchEvents: z.optional(
			z
				.union([z.literal(false), z.literal(true)])
				.describe(
						...
						z.object({
							...
							sudo: z.optional(
								z.object({
									...
									verifiedAt: z.optional(z.number()),
									expiresAt: z.number(),
								}),
							),
							origin: z.optional(
...
export const listFlagsPathParamsSchema = z.object({
	projectIdOrName: z.string().describe("The project id or name"),
});

export const listFlagsQueryParamsSchema = z
	.object({
		state: z.optional(
			z
...
export const listFlags200Schema = z.unknown();

/**
 * @description One of the provided values in the request query is invalid.
 */
export const listFlags400Schema = z.unknown();
 ...
 * @description You do not have permission to access this resource.
 */
export const listFlags403Schema = z.unknown();

export const listFlags404Schema = z.unknown();

export const listFlagsQueryResponseSchema = z.lazy(() => listFlags200Schema);

export const createFlagPathParamsSchema = z.object({
	projectIdOrName: z.string().describe("The project id or name"),
});

export const createFlagQueryParamsSchema = z
	.object({
		teamId: z.optional(
			z.string().describe("The Team identifier to perform the request on behalf of."),
		),
...
export const createFlag201Schema = z.unknown();

/**
 * @description One of the provided values in the request body is invalid.\nOne of the provided values in the request query is invalid.
 */
export const createFlag400Schema = z.unknown();
 ...
 * @description You do not have permission to access this resource.
 */
export const createFlag403Schema = z.unknown();

export const createFlag404Schema = z.unknown();

export const createFlag409Schema = z.unknown();

export const createFlag412Schema = z.unknown();

export const createFlagMutationResponseSchema = z.lazy(() => createFlag201Schema);

export const getFlagPathParamsSchema = z.object({
	projectIdOrName: z.string().describe("The project id or name"),
	flagIdOrSlug: z.string().describe("The flag id or name"),
});

export const getFlagQueryParamsSchema = z
	.object({
		ifMatch: z.optional(
			z.string().describe("Etag to match, can be used interchangeably with the `if-match` header"),
		),
		withMetadata: z.optional(z.boolean().describe("Whether to include metadata in the response")),
		teamId: z.optional(
			z.string().describe("The Team identifier to perform the request on behalf of."),
...
export const getFlag200Schema = z.unknown();

export const getFlag304Schema = z.unknown();

/**
 * @description One of the provided values in the request query is invalid.
 */
export const getFlag400Schema = z.unknown();
 ...
 * @description You do not have permission to access this resource.
 */
export const getFlag403Schema = z.unknown();

export const getFlag404Schema = z.unknown();

export const getFlagQueryResponseSchema = z.lazy(() => getFlag200Schema);

export const updateFlagPathParamsSchema = z.object({
	projectIdOrName: z.string().describe("The project id or name"),
	flagIdOrSlug: z.string().describe("The flag id or name"),
});

export const updateFlagQueryParamsSchema = z
	.object({
		ifMatch: z.optional(
			z.string().describe("Etag to match, can be used interchangeably with the `if-match` header"),
		),
...
export const updateFlag200Schema = z.unknown();

export const updateFlag304Schema = z.unknown();

/**
 * @description One of the provided values in the request body is invalid.\nOne of the provided values in the request query is invalid.
 */
export const updateFlag400Schema = z.unknown();
 ...
 * @description You do not have permission to access this resource.
 */
export const updateFlag403Schema = z.unknown();

export const updateFlag404Schema = z.unknown();

export const updateFlag409Schema = z.unknown();

export const updateFlag412Schema = z.unknown();

export const updateFlagMutationResponseSchema = z.lazy(() => updateFlag200Schema);

export const deleteFlagPathParamsSchema = z.object({
	projectIdOrName: z.string().describe("The project id or name"),
	flagIdOrSlug: z.string().describe("The flag id or name"),
});

export const deleteFlagQueryParamsSchema = z
	.object({
		ifMatch: z.optional(
			z.string().describe("Etag to match, can be used interchangeably with the `if-match` header"),
		),
...
export const deleteFlag204Schema = z.unknown();

export const deleteFlag304Schema = z.unknown();

/**
 * @description One of the provided values in the request query is invalid.
 */
export const deleteFlag400Schema = z.unknown();
 ...
 * @description You do not have permission to access this resource.
 */
export const deleteFlag403Schema = z.unknown();

export const deleteFlag404Schema = z.unknown();

export const deleteFlag409Schema = z.unknown();

export const deleteFlag412Schema = z.unknown();

export const deleteFlagMutationResponseSchema = z.lazy(() => deleteFlag204Schema);

export const listFlagVersionsPathParamsSchema = z.object({
	projectIdOrName: z.string(),
	flagIdOrSlug: z.string(),
});

export const listFlagVersionsQueryParamsSchema = z.object({
	limit: z.coerce.number().min(1).max(100).default(20),
	cursor: z.optional(z.string().describe("Pagination cursor")),
	environment: z.optional(z.string().describe("Environment to filter by")),
	withMetadata: z.boolean().default(false).describe("Whether to include metadata"),
	teamId: z.optional(
		z.string().describe("The Team identifier to perform the request on behalf of."),
	),
	slug: z.optional(z.string().describe("The Team slug to perform the request on behalf of.")),
...
export const listFlagVersions200Schema = z.unknown();

export const listFlagVersions304Schema = z.unknown();

/**
 * @description One of the provided values in the request query is invalid.
 */
export const listFlagVersions400Schema = z.unknown();
 ...
 * @description You do not have permission to access this resource.
 */
export const listFlagVersions403Schema = z.unknown();

export const listFlagVersions404Schema = z.unknown();

export const listFlagVersionsQueryResponseSchema = z.lazy(() => listFlagVersions200Schema);

export const getFlagSettingsPathParamsSchema = z.object({
	projectIdOrName: z.string().describe("The project id or name"),
});

export const getFlagSettingsQueryParamsSchema = z
	.object({
		teamId: z.optional(
			z.string().describe("The Team identifier to perform the request on behalf of."),
		),
...
export const getFlagSettings200Schema = z.unknown();

/**
 * @description One of the provided values in the request query is invalid.
 */
export const getFlagSettings400Schema = z.unknown();
 ...
 * @description You do not have permission to access this resource.
 */
export const getFlagSettings403Schema = z.unknown();

export const getFlagSettings404Schema = z.unknown();

export const getFlagSettingsQueryResponseSchema = z.lazy(() => getFlagSettings200Schema);

export const updateFlagSettingsPathParamsSchema = z.object({
	projectIdOrName: z.string().describe("The project id or name"),
});

export const updateFlagSettingsQueryParamsSchema = z
	.object({
		teamId: z.optional(
			z.string().describe("The Team identifier to perform the request on behalf of."),
		),
 ...
 * @description One of the provided values in the request body is invalid.\nOne of the provided values in the request query is invalid.
 */
export const updateFlagSettings400Schema = z.unknown();
 ...
 * @description You do not have permission to access this resource.
 */
export const updateFlagSettings403Schema = z.unknown();

export const updateFlagSettings404Schema = z.unknown();

export const updateFlagSettings409Schema = z.unknown();
...
export const listTeamFlagSettingsQueryParamsSchema = z.object({
	limit: z.coerce
		.number()
		.int()
		.min(1)
...
export const listTeamFlagSettings200Schema = z.unknown();

/**
 * @description One of the provided values in the request query is invalid.
 */
export const listTeamFlagSettings400Schema = z.unknown();

/**
 * @description The request is not authorized.
 */
export const listTeamFlagSettings401Schema = z.unknown();

/**
 * @description You do not have permission to access this resource.
 */
export const listTeamFlagSettings403Schema = z.unknown();

export const listTeamFlagSettingsQueryResponseSchema = z.lazy(() => listTeamFlagSettings200Schema);

export const listTeamFlagsPathParamsSchema = z.object({
	teamId: z.string().describe("The Team identifier to perform the request on behalf of."),
});

export const listTeamFlagsQueryParamsSchema = z.object({
	state: z.optional(
		z
			.enum(["active", "archived"])
			.describe("The state of the flags to retrieve. Defaults to `active`."),
...
export const listTeamFlags200Schema = z.unknown();

/**
 * @description One of the provided values in the request query is invalid.
 */
export const listTeamFlags400Schema = z.unknown();

/**
 * @description The request is not authorized.
 */
export const listTeamFlags401Schema = z.unknown();

/**
 * @description You do not have permission to access this resource.
 */
export const listTeamFlags403Schema = z.unknown();

export const listTeamFlagsQueryResponseSchema = z.lazy(() => listTeamFlags200Schema);

export const createFlagSegmentPathParamsSchema = z.object({
	projectIdOrName: z.string().describe("The project id or name"),
});

export const createFlagSegmentQueryParamsSchema = z
	.object({
		teamId: z.optional(
			z.string().describe("The Team identifier to perform the request on behalf of."),
		),
...
export const createFlagSegment201Schema = z.unknown();

/**
 * @description One of the provided values in the request body is invalid.\nOne of the provided values in the request query is invalid.
 */
export const createFlagSegment400Schema = z.unknown();
 ...
 * @description You do not have permission to access this resource.
 */
export const createFlagSegment403Schema = z.unknown();

export const createFlagSegment404Schema = z.unknown();

export const createFlagSegment409Schema = z.unknown();

export const createFlagSegment412Schema = z.unknown();

export const createFlagSegmentMutationResponseSchema = z.lazy(() => createFlagSegment201Schema);

export const listFlagSegmentsPathParamsSchema = z.object({
	projectIdOrName: z.string().describe("The project id or name"),
});

export const listFlagSegmentsQueryParamsSchema = z.object({
	withMetadata: z.boolean().default(false).describe("Whether to include metadata"),
	teamId: z.optional(
		z.string().describe("The Team identifier to perform the request on behalf of."),
	),
...
export const listFlagSegments200Schema = z.unknown();

/**
 * @description One of the provided values in the request query is invalid.
 */
export const listFlagSegments400Schema = z.unknown();
 ...
 * @description You do not have permission to access this resource.
 */
export const listFlagSegments403Schema = z.unknown();

export const listFlagSegments404Schema = z.unknown();

export const listFlagSegmentsQueryResponseSchema = z.lazy(() => listFlagSegments200Schema);

export const getFlagSegmentPathParamsSchema = z.object({
	projectIdOrName: z.string().describe("The project id or name"),
	segmentIdOrSlug: z.string().describe("The segment slug"),
});

export const getFlagSegmentQueryParamsSchema = z.object({
	withMetadata: z.boolean().default(false).describe("Whether to include metadata"),
	teamId: z.optional(
		z.string().describe("The Team identifier to perform the request on behalf of."),
	),
...
export const getFlagSegment200Schema = z.unknown();

/**
 * @description One of the provided values in the request query is invalid.
 */
export const getFlagSegment400Schema = z.unknown();
 ...
 * @description You do not have permission to access this resource.
 */
export const getFlagSegment403Schema = z.unknown();

export const getFlagSegment404Schema = z.unknown();

export const getFlagSegmentQueryResponseSchema = z.lazy(() => getFlagSegment200Schema);

export const deleteFlagSegmentPathParamsSchema = z.object({
	projectIdOrName: z.string().describe("The project id or name"),
	segmentIdOrSlug: z.string().describe("The segment slug"),
});

export const deleteFlagSegmentQueryParamsSchema = z.object({
	withMetadata: z.boolean().default(false).describe("Whether to include metadata"),
	teamId: z.optional(
		z.string().describe("The Team identifier to perform the request on behalf of."),
	),
...
export const deleteFlagSegment204Schema = z.unknown();

/**
 * @description One of the provided values in the request query is invalid.
 */
export const deleteFlagSegment400Schema = z.unknown();
 ...
 * @description You do not have permission to access this resource.
 */
export const deleteFlagSegment403Schema = z.unknown();

export const deleteFlagSegment404Schema = z.unknown();

export const deleteFlagSegment409Schema = z.unknown();

export const deleteFlagSegment412Schema = z.unknown();

export const deleteFlagSegmentMutationResponseSchema = z.lazy(() => deleteFlagSegment204Schema);

export const updateFlagSegmentPathParamsSchema = z.object({
	projectIdOrName: z.string().describe("The project id or name"),
	segmentIdOrSlug: z.string().describe("The segment slug"),
});

export const updateFlagSegmentQueryParamsSchema = z.object({
	withMetadata: z.boolean().default(false).describe("Whether to include metadata"),
	teamId: z.optional(
		z.string().describe("The Team identifier to perform the request on behalf of."),
	),
...
export const updateFlagSegment200Schema = z.unknown();

/**
 * @description One of the provided values in the request body is invalid.\nOne of the provided values in the request query is invalid.
 */
export const updateFlagSegment400Schema = z.unknown();
 ...
 * @description You do not have permission to access this resource.
 */
export const updateFlagSegment403Schema = z.unknown();

export const updateFlagSegment404Schema = z.unknown();

export const updateFlagSegment409Schema = z.unknown();

export const updateFlagSegment412Schema = z.unknown();

export const updateFlagSegmentMutationResponseSchema = z.lazy(() => updateFlagSegment200Schema);

export const getDeploymentFeatureFlagsPathParamsSchema = z.object({
	deploymentId: z.string(),
});

export const getDeploymentFeatureFlagsQueryParamsSchema = z
	.object({
		teamId: z.optional(
			z.string().describe("The Team identifier to perform the request on behalf of."),
		),
...
export const getDeploymentFeatureFlags200Schema = z.unknown();

/**
 * @description One of the provided values in the request query is invalid.
 */
export const getDeploymentFeatureFlags400Schema = z.unknown();

/**
 * @description The request is not authorized.
 */
export const getDeploymentFeatureFlags401Schema = z.unknown();

/**
 * @description You do not have permission to access this resource.
 */
export const getDeploymentFeatureFlags403Schema = z.unknown();

export const getDeploymentFeatureFlags404Schema = z.unknown();

export const getDeploymentFeatureFlagsQueryResponseSchema = z.lazy(
	() => getDeploymentFeatureFlags200Schema,
);

export const getSdkKeysPathParamsSchema = z.object({
	projectIdOrName: z.string().describe("The project id or name"),
});

export const getSdkKeysQueryParamsSchema = z
	.object({
		teamId: z.optional(
			z.string().describe("The Team identifier to perform the request on behalf of."),
		),
...
export const getSdkKeys200Schema = z.unknown();

/**
 * @description One of the provided values in the request query is invalid.
 */
export const getSdkKeys400Schema = z.unknown();
 ...
 * @description You do not have permission to access this resource.
 */
export const getSdkKeys403Schema = z.unknown();

export const getSdkKeys404Schema = z.unknown();

export const getSdkKeysQueryResponseSchema = z.lazy(() => getSdkKeys200Schema);

export const createSdkKeyPathParamsSchema = z.object({
	projectIdOrName: z.string().describe("The project id or name"),
});

export const createSdkKeyQueryParamsSchema = z
	.object({
		teamId: z.optional(
			z.string().describe("The Team identifier to perform the request on behalf of."),
		),
...
export const createSdkKey200Schema = z.unknown();

/**
 * @description One of the provided values in the request body is invalid.\nOne of the provided values in the request query is invalid.
 */
export const createSdkKey400Schema = z.unknown();
 ...
 * @description You do not have permission to access this resource.
 */
export const createSdkKey403Schema = z.unknown();

export const createSdkKey404Schema = z.unknown();

export const createSdkKey409Schema = z.unknown();

export const createSdkKeyMutationResponseSchema = z.lazy(() => createSdkKey200Schema);

export const deleteSdkKeyPathParamsSchema = z.object({
	projectIdOrName: z.string().describe("The project id or name"),
	hashKey: z.string().describe("The SDK key hash key to delete"),
});

export const deleteSdkKeyQueryParamsSchema = z
	.object({
		teamId: z.optional(
			z.string().describe("The Team identifier to perform the request on behalf of."),
		),
...
export const deleteSdkKey204Schema = z.unknown();

/**
 * @description One of the provided values in the request query is invalid.
 */
export const deleteSdkKey400Schema = z.unknown();
 ...
 * @description You do not have permission to access this resource.
 */
export const deleteSdkKey403Schema = z.unknown();

export const deleteSdkKey404Schema = z.unknown();

export const deleteSdkKey409Schema = z.unknown();

export const deleteSdkKeyMutationResponseSchema = z.lazy(() => deleteSdkKey204Schema);
 ...
 * @description One of the provided values in the request body is invalid.
 */
export const createSandbox400Schema = z.unknown();
 ...
 */
export const createSandbox429Schema = z.unknown();

export const createSandbox500Schema = z.unknown();

export const createSandboxMutationResponseSchema = z.lazy(() => createSandbox200Schema);

export const listSnapshotsQueryParamsSchema = z
	.object({
		project: z.optional(
...
export const listSnapshots200Schema = z.unknown();

/**
 * @description One of the provided values in the request query is invalid.
 */
export const listSnapshots400Schema = z.unknown();

/**
 * @description The request is not authorized.
 */
export const listSnapshots401Schema = z.unknown();

/**
 * @description You do not have permission to access this resource.
 */
export const listSnapshots403Schema = z.unknown();

export const listSnapshots404Schema = z.unknown();

export const listSnapshotsQueryResponseSchema = z.lazy(() => listSnapshots200Schema);

export const getSandboxPathParamsSchema = z.object({
	sandboxId: z.string().describe("The unique identifier of the sandbox to retrieve."),
});

export const getSandboxQueryParamsSchema = z
	.object({
		teamId: z.optional(
			z.string().describe("The Team identifier to perform the request on behalf of."),
		),
...
export const getSandbox200Schema = z.unknown();

/**
 * @description One of the provided values in the request query is invalid.
 */
export const getSandbox400Schema = z.unknown();

/**
 * @description The request is not authorized.
 */
export const getSandbox401Schema = z.unknown();
...
export const getSandbox404Schema = z.unknown();
...
export const listCommandsPathParamsSchema = z.object({
	sandboxId: z.string().describe("The unique identifier of the sandbox to list commands for."),
});

export const listCommandsQueryParamsSchema = z
	.object({
		teamId: z.optional(
			z.string().describe("The Team identifier to perform the request on behalf of."),
		),
 ...
 */
export const listCommands200Schema = z.unknown();

/**
 * @description One of the provided values in the request query is invalid.
 */
export const listCommands400Schema = z.unknown();

/**
 * @description The request is not authorized.
 */
export const listCommands401Schema = z.unknown();
...
export const listCommands404Schema = z.unknown();
...
export const runCommandQueryParamsSchema = z
	.object({
		teamId: z.optional(
			z.string().describe("The Team identifier to perform the request on behalf of."),
		),
...
export const runCommand200Schema = z.unknown();

/**
 * @description One of the provided values in the request body is invalid.\nOne of the provided values in the request query is invalid.
 */
export const runCommand400Schema = z.unknown();

/**
 * @description The request is not authorized.
 */
export const runCommand401Schema = z.unknown();
...
export const runCommand404Schema = z.unknown();
...
export const killCommandPathParamsSchema = z.object({
	cmdId: z.string().describe("The unique identifier of the command to terminate."),
	sandboxId: z.string().describe("The unique identifier of the sandbox containing the command."),
});

export const killCommandQueryParamsSchema = z
	.object({
		teamId: z.optional(
			z.string().describe("The Team identifier to perform the request on behalf of."),
		),
 ...
 */
export const killCommand200Schema = z.unknown();

/**
 * @description One of the provided values in the request body is invalid.\nOne of the provided values in the request query is invalid.
 */
export const killCommand400Schema = z.unknown();

/**
 * @description The request is not authorized.
 */
export const killCommand401Schema = z.unknown();

/**
 * @description You do not have permission to access this resource.
 */
export const killCommand403Schema = z.unknown();
...
export const stopSandboxPathParamsSchema = z.object({
	sandboxId: z.string().describe("The unique identifier of the sandbox to stop."),
});

export const stopSandboxQueryParamsSchema = z
	.object({
		teamId: z.optional(
			z.string().describe("The Team identifier to perform the request on behalf of."),
		),
 ...
 */
export const stopSandbox200Schema = z.unknown();

/**
 * @description One of the provided values in the request query is invalid.
 */
export const stopSandbox400Schema = z.unknown();

/**
 * @description The request is not authorized.
 */
export const stopSandbox401Schema = z.unknown();
...
export const stopSandbox404Schema = z.unknown();
...
export const extendSandboxTimeoutPathParamsSchema = z.object({
	sandboxId: z.string().describe("The unique identifier of the sandbox to extend the timeout for."),
});

export const extendSandboxTimeoutQueryParamsSchema = z
	.object({
		teamId: z.optional(
			z.string().describe("The Team identifier to perform the request on behalf of."),
		),
 ...
 */
export const extendSandboxTimeout200Schema = z.unknown();

/**
 * @description One of the provided values in the request body is invalid.\nOne of the provided values in the request query is invalid.
 */
export const extendSandboxTimeout400Schema = z.unknown();

/**
 * @description The request is not authorized.
 */
export const extendSandboxTimeout401Schema = z.unknown();
...
export const extendSandboxTimeoutMutationResponseSchema = z.lazy(
	() => extendSandboxTimeout200Schema,
);

export const updateNetworkPolicyPathParamsSchema = z.object({
	sandboxId: z
		.string()
		.describe("The unique identifier of the sandbox to update the network policy for."),
});

export const updateNetworkPolicyQueryParamsSchema = z
	.object({
		teamId: z.optional(
			z.string().describe("The Team identifier to perform the request on behalf of."),
		),
 ...
 */
export const updateNetworkPolicy200Schema = z.unknown();

/**
 * @description One of the provided values in the request body is invalid.\nOne of the provided values in the request query is invalid.
 */
export const updateNetworkPolicy400Schema = z.unknown();
...
export const getCommandPathParamsSchema = z.object({
	sandboxId: z.string().describe("The unique identifier of the sandbox containing the command."),
	cmdId: z.string().describe("The unique identifier of the command to retrieve."),
});

export const getCommandQueryParamsSchema = z.object({
	wait: z
		.enum(["true", "false"])
		.default("false")
		.describe(
 ...
 */
export const getCommand200Schema = z.unknown();

/**
 * @description One of the provided values in the request query is invalid.
 */
export const getCommand400Schema = z.unknown();

/**
 * @description The request is not authorized.
 */
export const getCommand401Schema = z.unknown();
...
export const getCommand404Schema = z.unknown();
...
export const getCommandLogsPathParamsSchema = z.object({
	sandboxId: z.string().describe("The unique identifier of the sandbox containing the command."),
	cmdId: z.string().describe("The unique identifier of the command to stream logs for."),
});

export const getCommandLogsQueryParamsSchema = z
	.object({
		teamId: z.optional(
			z.string().describe("The Team identifier to perform the request on behalf of."),
		),
...
export const getCommandLogs200Schema = z.unknown();

/**
 * @description One of the provided values in the request query is invalid.
 */
export const getCommandLogs400Schema = z.unknown();

/**
 * @description The request is not authorized.
 */
export const getCommandLogs401Schema = z.unknown();
...
export const getCommandLogs404Schema = z.unknown();
...
export const readFilePathParamsSchema = z.object({
	sandboxId: z.string().describe("The unique identifier of the sandbox to read the file from."),
});

export const readFileQueryParamsSchema = z
	.object({
		teamId: z.optional(
			z.string().describe("The Team identifier to perform the request on behalf of."),
		),
...
export const readFile200Schema = z.unknown();

/**
 * @description One of the provided values in the request body is invalid.\nOne of the provided values in the request query is invalid.
 */
export const readFile400Schema = z.unknown();

/**
 * @description The request is not authorized.
 */
export const readFile401Schema = z.unknown();

/**
 * @description You do not have permission to access this resource.
 */
export const readFile403Schema = z.unknown();
...
export const createDirectoryPathParamsSchema = z.object({
	sandboxId: z
		.string()
		.describe("The unique identifier of the sandbox to create the directory in."),
});

export const createDirectoryQueryParamsSchema = z
	.object({
		teamId: z.optional(
			z.string().describe("The Team identifier to perform the request on behalf of."),
		),
 ...
 */
export const createDirectory200Schema = z.unknown();

/**
 * @description One of the provided values in the request body is invalid.\nOne of the provided values in the request query is invalid.
 */
export const createDirectory400Schema = z.unknown();

/**
 * @description The request is not authorized.
 */
export const createDirectory401Schema = z.unknown();
...
export const createDirectory404Schema = z.unknown();
...
export const writeFilesPathParamsSchema = z.object({
	sandboxId: z.string().describe("The unique identifier of the sandbox to write files to."),
});

export const writeFilesQueryParamsSchema = z
	.object({
		teamId: z.optional(
			z.string().describe("The Team identifier to perform the request on behalf of."),
		),
 ...
 */
export const writeFiles200Schema = z.unknown();

/**
 * @description One of the provided values in the request query is invalid.\nOne of the provided values in the headers is invalid
 */
export const writeFiles400Schema = z.unknown();

/**
 * @description The request is not authorized.
 */
export const writeFiles401Schema = z.unknown();
...
export const writeFiles404Schema = z.unknown();
...
export const getSnapshotPathParamsSchema = z.object({
	snapshotId: z.string().describe("The unique identifier of the snapshot to retrieve."),
});

export const getSnapshotQueryParamsSchema = z
	.object({
		teamId: z.optional(
			z.string().describe("The Team identifier to perform the request on behalf of."),
		),
...
export const getSnapshot200Schema = z.unknown();

/**
 * @description One of the provided values in the request query is invalid.
 */
export const getSnapshot400Schema = z.unknown();

/**
 * @description The request is not authorized.
 */
export const getSnapshot401Schema = z.unknown();

/**
 * @description You do not have permission to access this resource.
 */
export const getSnapshot403Schema = z.unknown();

export const getSnapshot404Schema = z.unknown();

export const getSnapshotQueryResponseSchema = z.lazy(() => getSnapshot200Schema);

export const deleteSnapshotPathParamsSchema = z.object({
	snapshotId: z.string().describe("The unique identifier of the snapshot to delete."),
});

export const deleteSnapshotQueryParamsSchema = z
	.object({
		teamId: z.optional(
			z.string().describe("The Team identifier to perform the request on behalf of."),
		),
...
export const deleteSnapshot200Schema = z.unknown();

/**
 * @description One of the provided values in the request query is invalid.
 */
export const deleteSnapshot400Schema = z.unknown();

/**
 * @description The request is not authorized.
 */
export const deleteSnapshot401Schema = z.unknown();

/**
 * @description You do not have permission to access this resource.
 */
export const deleteSnapshot403Schema = z.unknown();

export const deleteSnapshot404Schema = z.unknown();

export const deleteSnapshotMutationResponseSchema = z.lazy(() => deleteSnapshot200Schema);

export const createSnapshotPathParamsSchema = z.object({
	sandboxId: z.string().describe("The unique identifier of the sandbox to snapshot."),
});

export const createSnapshotQueryParamsSchema = z
	.object({
		teamId: z.optional(
			z.string().describe("The Team identifier to perform the request on behalf of."),
		),
...
export const createSnapshot201Schema = z.unknown();

/**
 * @description One of the provided values in the request body is invalid.\nOne of the provided values in the request query is invalid.
 */
export const createSnapshot400Schema = z.unknown();
...
export const createSnapshot404Schema = z.unknown();
...
export const getSession404Schema = z.unknown();
...
export const getNamedSandbox410Schema = z.unknown();
...
export const updateSandboxQueryParamsSchema = z.object({
	projectId: z.optional(
		z
			.string()
			.max(128)
...
export const updateSandbox409Schema = z.unknown();
 ...
 * @description The concurrency limit has been exceeded.
 */
export const updateSandbox429Schema = z.unknown();
...
export const listSessionCommands404Schema = z.unknown();
...
export const runSessionCommand404Schema = z.unknown();
...
export const getSessionCommand404Schema = z.unknown();
...
export const getSessionCommandLogs404Schema = z.unknown();
...
export const stopSession404Schema = z.unknown();
...
export const createSessionDirectory404Schema = z.unknown();
...
export const writeSessionFiles404Schema = z.unknown();
...
export const createSessionSnapshot404Schema = z.unknown();
...
export const createTeam404Schema = z.unknown();

export const createTeam409Schema = z.unknown();
...
export const assignAliasPathParamsSchema = z.object({
	id: z.string().describe("The deployment or alias ID or URL to assign from"),
});
