---
title: "vercel-api-js"
description: "Type-safe Vercel API client with MCP support"
icon: "triangle"
---

A type-safe API client for the [Vercel Platform API](https://vercel.com/docs/rest-api), auto-generated from the official OpenAPI specification with full TypeScript support and MCP integration.
