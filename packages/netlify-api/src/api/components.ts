...
export type CreateSiteDatabaseError = Fetcher.ErrorWrapper<{
	status: Exclude<ClientErrorStatus | ServerErrorStatus, 200 | 201>;
	payload: {
		/**
		 * @format int64
		 */
...
export type CreateSiteDatabaseRequestBody = {
	/**
...
export type CreateSiteDatabaseVariables = {
	body?: CreateSiteDatabaseRequestBody;
 ...
 */
export const createSiteDatabase = (variables: CreateSiteDatabaseVariables, signal?: AbortSignal) =>
	fetch<
		CreateSiteDatabaseResponse,
		CreateSiteDatabaseError,
		CreateSiteDatabaseRequestBody,
		{},
		{},
		CreateSiteDatabasePathParams
	>({ url: "/sites/{siteId}/database", method: "post", ...variables, signal });

export type GetSiteDatabasePathParams = {
	siteId: string;
};

export type GetSiteDatabaseError = Fetcher.ErrorWrapper<{
	status: Exclude<ClientErrorStatus | ServerErrorStatus, 200>;
	payload: {
		/**
		 * @format int64
...
export type GetSiteDatabaseResponse = {
	/**
	 * The connection string for the database
	 */
	connection_string?: string;
...
export type GetSiteDatabaseVariables = {
 ...
 */
export const getSiteDatabase = (variables: GetSiteDatabaseVariables, signal?: AbortSignal) =>
	fetch<
		GetSiteDatabaseResponse,
		GetSiteDatabaseError,
		undefined,
		{},
		{},
		GetSiteDatabasePathParams
	>({ url: "/sites/{siteId}/database", method: "get", ...variables, signal });

export type DeleteSiteDatabasePathParams = {
	siteId: string;
};

export type DeleteSiteDatabaseError = Fetcher.ErrorWrapper<{
	status: Exclude<ClientErrorStatus | ServerErrorStatus, 204>;
	payload: {
		/**
		 * @format int64
...
export type DeleteSiteDatabaseVariables = {
 ...
 */
export const deleteSiteDatabase = (variables: DeleteSiteDatabaseVariables, signal?: AbortSignal) =>
	fetch<undefined, DeleteSiteDatabaseError, undefined, {}, {}, DeleteSiteDatabasePathParams>({
		url: "/sites/{siteId}/database",
		method: "delete",
		...variables,
		signal,
	});

export type CreateSiteDatabaseBranchPathParams = {
	siteId: string;
};

export type CreateSiteDatabaseBranchError = Fetcher.ErrorWrapper<{
	status: Exclude<ClientErrorStatus | ServerErrorStatus, 200 | 201>;
	payload: {
		/**
		 * @format int64
...
export type CreateSiteDatabaseBranchRequestBody = {
	/**
...
export type CreateSiteDatabaseBranchVariables = {
	body: CreateSiteDatabaseBranchRequestBody;
 ...
 */
export const createSiteDatabaseBranch = (
	variables: CreateSiteDatabaseBranchVariables,
	signal?: AbortSignal,
) =>
	fetch<
		CreateSiteDatabaseBranchResponse,
		CreateSiteDatabaseBranchError,
		CreateSiteDatabaseBranchRequestBody,
		{},
		{},
		CreateSiteDatabaseBranchPathParams
	>({
		url: "/sites/{siteId}/database/branch",
		method: "post",
		...variables,
		signal,
	});
...
export type GetSiteDatabaseBranchError = Fetcher.ErrorWrapper<{
	status: Exclude<ClientErrorStatus | ServerErrorStatus, 200 | 404>;
	payload: {
		/**
		 * @format int64
...
export type GetSiteDatabaseBranchVariables = {
 ...
 */
export const getSiteDatabaseBranch = (
	variables: GetSiteDatabaseBranchVariables,
	signal?: AbortSignal,
) =>
	fetch<
		GetSiteDatabaseBranchResponse,
		GetSiteDatabaseBranchError,
		undefined,
		{},
		{},
		GetSiteDatabaseBranchPathParams
	>({
		url: "/sites/{siteId}/database/branch/{deployId}",
		method: "get",
		...variables,
		signal,
	});

export type DeleteSiteDatabaseBranchPathParams = {
	siteId: string;
	/**
	 * The deploy ID associated with the database branch
	 */
...
export type DeleteSiteDatabaseBranchError = Fetcher.ErrorWrapper<{
	status: Exclude<ClientErrorStatus | ServerErrorStatus, 204>;
	payload: {
		/**
		 * @format int64
...
export type DeleteSiteDatabaseBranchVariables = {
 ...
 */
export const deleteSiteDatabaseBranch = (
	variables: DeleteSiteDatabaseBranchVariables,
	signal?: AbortSignal,
) =>
	fetch<
		undefined,
		DeleteSiteDatabaseBranchError,
		undefined,
		{},
		{},
...
export type CreateSiteDatabaseSnapshotError = Fetcher.ErrorWrapper<{
	status: Exclude<ClientErrorStatus | ServerErrorStatus, 201>;
	payload: {
		/**
		 * @format int64
...
export type CreateSiteDatabaseSnapshotRequestBody = {
	/**
...
export type CreateSiteDatabaseSnapshotVariables = {
	body?: CreateSiteDatabaseSnapshotRequestBody;
 ...
 */
export const createSiteDatabaseSnapshot = (
	variables: CreateSiteDatabaseSnapshotVariables,
	signal?: AbortSignal,
) =>
	fetch<
		CreateSiteDatabaseSnapshotResponse,
		CreateSiteDatabaseSnapshotError,
		CreateSiteDatabaseSnapshotRequestBody,
		{},
		{},
		CreateSiteDatabaseSnapshotPathParams
	>({
		url: "/sites/{siteId}/database/snapshot",
		method: "post",
		...variables,
		signal,
	});

export type ListSiteDatabaseSnapshotsPathParams = {
	siteId: string;
};

export type ListSiteDatabaseSnapshotsError = Fetcher.ErrorWrapper<{
	status: Exclude<ClientErrorStatus | ServerErrorStatus, 200>;
	payload: {
		/**
		 * @format int64
...
export type ListSiteDatabaseSnapshotsVariables = {
 ...
 */
export const listSiteDatabaseSnapshots = (
	variables: ListSiteDatabaseSnapshotsVariables,
	signal?: AbortSignal,
) =>
	fetch<
		ListSiteDatabaseSnapshotsResponse,
		ListSiteDatabaseSnapshotsError,
		undefined,
		{},
		{},
		ListSiteDatabaseSnapshotsPathParams
	>({
		url: "/sites/{siteId}/database/snapshots",
		method: "get",
		...variables,
		signal,
	});

export type DeleteSiteDatabaseSnapshotPathParams = {
	siteId: string;
	/**
	 * The snapshot ID
	 */
...
export type DeleteSiteDatabaseSnapshotError = Fetcher.ErrorWrapper<{
	status: Exclude<ClientErrorStatus | ServerErrorStatus, 204>;
	payload: {
		/**
		 * @format int64
...
export type DeleteSiteDatabaseSnapshotVariables = {
 ...
 */
export const deleteSiteDatabaseSnapshot = (
	variables: DeleteSiteDatabaseSnapshotVariables,
	signal?: AbortSignal,
) =>
	fetch<
		undefined,
		DeleteSiteDatabaseSnapshotError,
		undefined,
		{},
		{},
		DeleteSiteDatabaseSnapshotPathParams
	>({
		url: "/sites/{siteId}/database/snapshot/{snapshotId}",
		method: "delete",
		...variables,
		signal,
	});

export type RestoreSiteDatabaseSnapshotPathParams = {
	siteId: string;
	/**
...
export type RestoreSiteDatabaseSnapshotError = Fetcher.ErrorWrapper<{
	status: Exclude<ClientErrorStatus | ServerErrorStatus, 200>;
	payload: {
		/**
		 * @format int64
...
export type RestoreSiteDatabaseSnapshotRequestBody = {
	/**
...
export type RestoreSiteDatabaseSnapshotVariables = {
	body?: RestoreSiteDatabaseSnapshotRequestBody;
 ...
 */
export const restoreSiteDatabaseSnapshot = (
	variables: RestoreSiteDatabaseSnapshotVariables,
	signal?: AbortSignal,
) =>
	fetch<
		undefined,
		RestoreSiteDatabaseSnapshotError,
		RestoreSiteDatabaseSnapshotRequestBody,
		{},
		{},
		RestoreSiteDatabaseSnapshotPathParams
	>({
		url: "/sites/{siteId}/database/snapshot/{snapshotId}/restore",
		method: "post",
		...variables,
		signal,
	});
