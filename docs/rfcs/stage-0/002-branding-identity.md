...
Rebrand the VS Code AI Gateway extension from SferaDev to official Vercel identity, including publisher change, vendor namespace update, and visual identity refresh. Migration and deprecation mechanics are covered in [RFC 007](./007-migration-deprecation.md).

**Priority:** 1 of 3 in Vercel transition sequence.
...
Migration mechanics, namespace transitions, and deprecation timelines are defined in [RFC 007](./007-migration-deprecation.md).
