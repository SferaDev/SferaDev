...
## The Prime Directive
**Verify the Graph.**
The system is a graph of connected nodes (Tasks, Decisions, Docs, Code). Broken edges are failures.

## Protocol

1.  **Cross-Reference Check**
    - **Plan vs Decisions**: Does `docs/agent-context/plan.toml` contain tasks that implement "Rejected" decisions in `decisions.toml`?
    - **Plan vs Ideas**: Are "Active" tasks linked to "Approved" ideas?
