...
| --- | ----- | ------ | ------- | ---------- |
| [003a](./stage-0/003a-streaming-adapter.md) | Streaming Adapter Extraction | Draft | Extract stream adapter and chunk handling | [ref](./stage-0/ref-stream-mapping.md) |
| [003b](./stage-0/003b-token-estimation.md) | Token Estimation & Message Conversion | Draft | Hybrid token estimation, message conversion, MIME | — |
