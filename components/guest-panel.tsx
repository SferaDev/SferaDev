...
import { Plus, UserPlus, Trash2, Users, ImagePlus, X, Circle, RectangleHorizontal } from "lucide-react"
...
export function GuestPanel({
  ...
  const [seatArrangement, setSeatArrangement] = useState<"around" | "one-side" | "single-row">("around")
      ...
      >
        <div className="p-4 space-y-6 pb-8">
                ...
                <div className="flex items-center gap-3">
                  {guestPhoto ? (
                    <Avatar className="w-12 h-12 border-2 border-primary/20">
                      <AvatarImage src={guestPhoto || "/placeholder.svg"} />
                    </Avatar>
                  ) : (
              ...
              {tableShape === "rectangle" && (
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(v) => setSeatArrangement(v as "around" | "one-side" | "single-row")}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
          ...
          <Card>
            ...
            <CardContent>
              {guests.length === 0 ? (
                <p className="text-sm text-muted-foreground text-center py-4">No unseated guests. Add guests above!</p>
              ) : (
                <div className="space-y-2">
                  {guests.map((guest) => (
                    <div
