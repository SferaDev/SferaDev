...
export const listArchivedFiles200Schema = z.object({
	from: z.optional(z.iso.datetime().describe("The queried start date.")),
	meetings: z.optional(
		z
			.array(
				z.object({
					...
					start_time: z.iso.datetime().describe("The meeting or webinar's start time."),
					timezone: z
						.string()
						.describe(
	...
	to: z.optional(z.iso.datetime().describe("The queried end date.")),
...
export const recordingGet200Schema = z
	...
	.and(
		z.object({
			...
			start_time: z.optional(z.iso.datetime().describe("The time when the meeting started.")),
					...
					.array(
						z.object({
							...
							recording_start: z.optional(
								z.iso.datetime().describe("The recording file's start time."),
							),
			...
			.array(
				z.object({
					date_time: z.optional(
						z.iso.datetime().describe("Explicit time to watch or download the recording."),
					),
					...
					.and(
						z.object({
							...
							start_time: z.optional(
								z.iso.datetime().describe("The time when the meeting started."),
							),
							topic: z.optional(z.string().describe("Meeting topic.")),
							total_size: z.optional(
								z
	...
	params: z.optional(
		z
			.object({
				...
				retain_meeting_transcript: z.optional(
					z
						.boolean()
						.describe(
						...
						.and(
							z.object({
								...
								create_time: z.optional(
									z.iso.datetime().describe("The time when the registrant registered."),
								),
								join_url: z.optional(
									z
										.string()
...
export const meetingRegistrantCreate201Schema = z.object({
	...
	start_time: z.optional(z.iso.datetime().describe("The meeting's start time.")),
			...
			.array(
				z
					.object({
						...
						start_time: z.optional(z.iso.datetime().describe("Start time.")),
...
export const meetingRegistrantGet200Schema = z
	...
	.and(
		z.object({
			id: z.optional(z.string()),
			create_time: z.optional(
				z.iso.datetime().describe("The registrant's registration date and time."),
			),
			join_url: z.optional(
...
export const meeting200Schema = z
	.object({
		...
		created_at: z.optional(z.iso.datetime().describe("The creation time. ")),
...
export const pastMeetingDetails200Schema = z.object({
	...
	start_time: z.optional(z.iso.datetime().describe("The meeting's start date and time.")),
	end_time: z.optional(z.iso.datetime().describe("The meeting's end date and time.")),
		...
		z
			.array(
				z.object({
					...
					join_time: z.optional(z.iso.datetime().describe("Participant join time.")),
					leave_time: z.optional(z.iso.datetime().describe("Participant leave time.")),
					duration: z.optional(
						z
							.int()
							.describe(
		...
		z
			.array(
				z.object({
					...
					created_at: z.optional(z.iso.datetime().describe("Time of creation.")),
					duration: z.optional(z.int().describe("Meeting duration.")),
					host_id: z.optional(
...
export const meetingCreate201Schema = z
	.object({
		...
		created_at: z.optional(
			z.iso.datetime().describe("The date and time when this meeting was created."),
		),
		duration: z.optional(z.int().describe("The meeting duration.")),
		encrypted_password: z.optional(
			z.string().describe("Encrypted passcode for third party endpoints (H323/SIP)."),
		...
		z
			.array(
				z.object({
					...
					created_at: z.optional(z.iso.datetime().describe("The meeting creation time.")),
					join_url: z.optional(
...
export const listPastMeetingPolls200Schema = z.object({
	...
	start_time: z.optional(z.iso.datetime().describe("The start time of the meeting.")),
	uuid: z.optional(z.string().describe("Meeting UUID.")),
});
			...
			z
				.array(
					z.object({
						...
						time: z.optional(z.iso.datetime().describe("Time during which the activity occurred.")),
						type: z.optional(
							z
		...
		z
			.array(
				z.object({
					...
					time: z.optional(
						z.iso.datetime().describe("The time at which the operation was performed."),
					),
				}),
			)
		...
		z
			.array(
				z.object({
					...
					end_time: z.optional(z.iso.datetime().describe("Call leg end time")),
					...
					start_time: z.optional(z.iso.datetime().describe("Call leg start time")),
					total: z.optional(
						z
							.number()
		...
		z
			.array(
				z.object({
					...
					join_time: z.optional(z.iso.datetime().describe("The participant's join time.")),
					leave_time: z.optional(z.iso.datetime().describe("The participant's leave time.")),
					name: z.optional(
						z
							.string()
							.describe(
...
export const reportWebinarQA200Schema = z.object({
	...
	start_time: z.optional(z.iso.datetime().describe("Webinar start time.")),
	uuid: z.optional(
		z
			.string()
			.describe(
				...
				z
					.object({
						...
						meeting_start_time: z.optional(
							z.iso.datetime().describe("The meeting's start date and time."),
						),
						meeting_end_time: z.optional(
							z.iso.datetime().describe("The meeting's end date and time."),
						),
						summary_start_time: z.optional(
							z.iso.datetime().describe("The summary's start date and time."),
						),
						summary_end_time: z.optional(
							z.iso.datetime().describe("The summary's end date and time."),
						),
						summary_created_time: z.optional(
							z.iso.datetime().describe("The date and time when the meeting summary was created."),
						),
...
export const getameetingsummary200Schema = z.object({
	...
	meeting_topic: z.optional(z.string().describe("The meeting topic.")),
	meeting_start_time: z.optional(z.iso.datetime().describe("The meeting's start date and time.")),
	meeting_end_time: z.optional(z.iso.datetime().describe("The meeting's end date and time.")),
	summary_start_time: z.optional(z.iso.datetime().describe("The summary's start date and time.")),
	summary_end_time: z.optional(z.iso.datetime().describe("The summary's end date and time.")),
	summary_created_time: z.optional(
		z.iso.datetime().describe("The date and time when the meeting summary was created."),
	),
	summary_last_modified_time: z.optional(
		z.iso.datetime().describe("The date and time when the meeting summary was last modified."),
	),
...
export const webinarCreate201Schema = z
	.object({
		...
		created_at: z.optional(z.iso.datetime().describe("Creation time.")),
		...
		start_time: z.optional(z.iso.datetime().describe("Webinar start time in GMT/UTC.")),
		start_url: z.optional(
			z
				.string()
				.describe(
...
export const webinar200Schema = z
	.object({
		...
		created_at: z.optional(z.iso.datetime().describe("Create time.")),
...
export const webinarPanelistCreate201Schema = z.object({
	...
	updated_at: z.optional(z.iso.datetime().describe("The time when the panelist was added.")),
});
...
export const webinarRegistrantGet200Schema = z
	...
	.and(
		z.object({
			id: z.optional(z.string()),
			create_time: z.optional(z.iso.datetime()),
